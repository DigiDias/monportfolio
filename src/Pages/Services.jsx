    ...
    <main style={{ paddingTop: "100px" }}>
      <div>
        <div className="center">
          <h2 className="title-h2 fw-semibold">Mon offre de services</h2>
        ...
        <div className="Contener-Card row d-flex justify-content-evenly mb-4 gap-4">
          <div
            className="card col-md-4 col-sm-4 col-12 mb-3"
            style={{ width: "18rem" }}
          >
            <div className="card-body d-flex  flex-column align-items-center ">
              ...
              <p className="card-text text-center">
                l'UX Design est une discipline qui consite à concevoir des
                produits (sitesweb, applications mobiles, logiciels, objects
                connéctés, etc) en plaçant l'utilisateur
              </p>
            </div>
          </div>
          ...
          >
            <div className="card-body d-flex  flex-column align-items-center">
              ...
              <p className="card-text text-center">
                Le développement de sites web consites à créer des sites
                internet en utilisant des langages de programmation (HTML, CSS,
                JavaScript, PHP, etc.) et des frameworks (Boorstrap, react,
                Angular, ect).
              </p>
            </div>
          </div>
          ...
          >
            <div className="card-body d-flex  flex-column align-items-center">
              ...
              <p className="card-text text-center">
                Le référencement naturel (SEO) est une technique qui consite à
                optimiser un site web pour le faire remonter dans les résultats
                des moteurs de recherche (Google, Bing, Yahoo, ect.). L'objectif
