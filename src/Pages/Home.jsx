...
const Home = () => {
    return (
        <main>
        <div className="home">
        <h1 className="title-h1">Bonjour, je suis John Doe</h1>
        <h2 className="title-h2">Développeur web full stack</h2>
        <button type="button" className="btn btn-danger">En savoir plus</button>
      </div>
      <section className="cont-A">
        <article className="cont-A-1">
    <p className="title-cont-A">À propos</p>
...
<article className="cont-A-2">
        <p className="title-cont-A">Mes compétences</p>
